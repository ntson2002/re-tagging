...
optparser.add_option(
    "-u", "--prefix", default=default_prefix,
    help=""
)
...
embedding_params, model_params = model.count_parameters()
from tabulate import tabulate
print tabulate(embedding_params, ["name", "shape", "size"])
...
for epoch in xrange(n_epochs):
    ...
    for i, index in enumerate(np.random.permutation(len(train_data))):
        ...
        # print word_for_output.shape, word_rev_output.shape, tempppp.shape
