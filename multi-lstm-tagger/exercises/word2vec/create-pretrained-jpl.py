...
# type = "word2vec"
# word2vec_file = "/home/sonnguyen/jaist/Bitbucket/lstm-crf-tagging/experiments/journal/jpl/w2vec/wiki.ja.vec"
# binary=False
# train = "/home/sonnguyen/jaist/Bitbucket/lstm-crf-tagging/experiments/jp-rre/data-japanese/jpl-data.txt"
# out_pickle = "/home/sonnguyen/jaist/Bitbucket/lstm-crf-tagging/experiments/jp-rre/data-japanese/jpl-rre.w2v300"
# out_txt = "/home/sonnguyen/jaist/Bitbucket/lstm-crf-tagging/experiments/jp-rre/data-japanese/jpl-rre.w2v300.txt"


type = "gensim"
word2vec_file = "/home/s1520203/Bitbucket/lstm-crf-tagging/experiments/journal/jpl/w2vec/word2vec-jp/word2vec.gensim.model"
binary=False
train = "/home/s1520203/Bitbucket/lstm-crf-tagging/experiments/jp-rre/data-japanese/jpl-data.txt"
out_pickle = "/home/s1520203/Bitbucket/lstm-crf-tagging/experiments/jp-rre/data-japanese/jpl-rre.w2v50"
out_txt = "/home/s1520203/Bitbucket/lstm-crf-tagging/experiments/jp-rre/data-japanese/jpl-rre.w2v50.txt"
...
if type == "word2vec":
    model = gensim.models.KeyedVectors.load_word2vec_format(opts.word2vec_file, binary=binary, unicode_errors='ignore')
if type == "gensim":
    model = gensim.models.KeyedVectors.load(opts.word2vec_file)
print "finish"
