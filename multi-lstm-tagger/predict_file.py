...
folder = os.getenv("MY_HOME") + "/Bitbucket/lstm-crf-tagging/experiments/journal/jpc-3layer/03.BI-LSTM-CRF-pretrained-emb50/06.crf-emb-feature-lr002"
default_model = folder + "/models/prefix=8,model_type=multilayer"
default_test_file = os.getenv("MY_HOME") + "/Bitbucket/lstm-crf-tagging/experiments/journal/jcc/data/train-dev-test/3layer/fold.8.train.conll"
default_out_file = "fold.8.train.conll.txt"
default_prefix = ""
